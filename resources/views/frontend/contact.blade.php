        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow card-border">
                        <div class="ltn__contact-address-icon">
                            <img src="{{url('public/frontend/assets/email.png') }}" alt="Icon Image">
                        </div>
                        <h3>Email Address</h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow card-border">
                        <div class="ltn__contact-address-icon">
                            <img src="{{url('public/frontend/assets/phone-call.png') }}" alt="Icon Image">
                        </div>
                        <h3>Phone No
                        </h3>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow card-border">
                        <div class="ltn__contact-address-icon">
                            <img src="{{url('public/frontend/assets/placeholder.png') }}" alt="Icon Image">
                        </div>
                        <h3>Office Address
                        </h3>
