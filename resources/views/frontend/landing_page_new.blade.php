        ...
        <div class="container">
            <div class="content-container">
                <div class="row mt-50">
                            ...
                            <div class="d-flex gap-4 pt-40">
                                <div class="btn-playstore">
                                    <a href="#" class=" store-btn"> <img class="mr-2"
                                            src="{{ url('public/assets/images/playstorelogo.png') }}" alt="">
                                        Playstore</a>
                                </div>
                                <div class="btn-appstore">
                                    <a href="#" class="store-btn"><img class="mr-2"
                                            src="{{ url('public/assets/images/logoappstore.png') }}"
                                            alt="">Appstore</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="user-img">
                            <img src="{{ url('public/assets/images/user.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <section class="mt-5 mb-5 works-section">
            <div class="row">
                <div class="col-md-6">
                    <div class="about-img">
                        <img src="{{ url('public/assets/images/welcome-double-exposure-business-man-partner-handshake 1.png') }}"
                            alt="">
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="container">
            ...
            <div class="row">
                <div data-menu="finance" class="single col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card pb-15">
                        <div class="portfolio-img">
                            <img src="{{ url('public/assets/images/portfolio1.png') }}" alt="">
                        </div>
                ...
                <div data-menu="enu" class="single col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card pb-15">
                        <div class="portfolio-img">
                            <img src="{{ url('public/assets/images/portfolio2.png') }}" alt="">
                        </div>
                        <div class="portfolio-content">
                            <h6>Web & Software Dev</h6>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                ...
                <div data-menu="health" class="single col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card pb-15">
                        <div class="portfolio-img">
                            <img src="{{ url('public/assets/images/portfolio3.png') }}" alt="">
                        </div>
                        <div class="portfolio-content">
                            <h6>Web & Software Dev</h6>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                ...
                <div data-menu="enu" class="single col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card pb-15">
                        <div class="portfolio-img">
                            <img src="{{ url('public/assets/images/portfolio4.png') }}" alt="">
                        </div>
                        <div class="portfolio-content">
                            <h6>Web & Software Dev</h6>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                ...
                <div data-menu="finance" class="single col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card pb-15">
                        <div class="portfolio-img">
                            <img src="{{ url('public/assets/images/portfolio5.png') }}" alt="">
                        </div>
                        <div class="portfolio-content">
                            <h6>Web & Software Dev</h6>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                ...
                <div data-menu="health" class="single col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card pb-15">
                        <div class="portfolio-img">
                            <img src="{{ url('public/assets/images/portfolio6.png') }}" alt="">
                        </div>
                        <div class="portfolio-content">
                            <h6>Web & Software Dev</h6>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                ...
                <div data-menu="enu" class="single col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card pb-15">
                        <div class="portfolio-img">
                            <img src="{{ url('public/assets/images/portfolio7.png') }}" alt="">
                        </div>
                        <div class="portfolio-content">
                            <h6>Web & Software Dev</h6>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                ...
                <div data-menu="education" class="single col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card pb-15">
                        <div class="portfolio-img">
                            <img src="{{ url('public/assets/images/portfolio8.png') }}" alt="">
                        </div>
                        <div class="portfolio-content">
                            <h6>Web & Software Dev</h6>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div class="row g-0">
                    ...
                    <div class="portfolio-card">
                        <div class="portfolio-bg-pink">
                            <div class="portfolio-img-management">
                                <img src="{{ url('public/assets/images/memeber1.png') }}" alt="">
                            </div>
                ...
                <div data-menu="team_leads" class="single_management col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card">
                        <div class="portfolio-bg-blue">
                            <div class="portfolio-img-management">
                                <img src="{{ url('public/assets/images/member2.png') }}" alt="">
                            </div>
                            <div class="text-center">
                ...
                <div data-menu="engineers" class="single_management col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card">
                        <div class="portfolio-bg-pink">
                            <div class="portfolio-img-management">
                                <img src="{{ url('public/assets/images/member3.png') }}" alt="">
                            </div>
                            <div class="text-center">
                ...
                <div data-menu="team_leads" class="single_management col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card">
                        <div class="portfolio-bg-blue">
                            <div class="portfolio-img-management">
                                <img src="{{ url('public/assets/images/member4.png') }}" alt="">
                            </div>
                            <div class="text-center">
                ...
                <div data-menu="management" class="single_management col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card">
                        <div class="portfolio-bg-pink">
                            <div class="portfolio-img-management">
                                <img src="{{ url('public/assets/images/member5.png') }}" alt="">
                            </div>
                            <div class="text-center">
                ...
                <div data-menu="hr" class="single_management col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card">
                        <div class="portfolio-bg-blue">
                            <div class="portfolio-img-management">
                                <img src="{{ url('public/assets/images/member6.png') }}" alt="">
                            </div>
                            <div class="text-center">
                ...
                <div data-menu="team_leads" class="single_management col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card">
                        <div class="portfolio-bg-pink">
                            <div class="portfolio-img-management">
                                <img src="{{ url('public/assets/images/member7.png') }}" alt="">
                            </div>
                            <div class="text-center">
                ...
                <div data-menu="managers" class="single_management col-lg-3 col-md-4 p-2 col-sm-6">
                    <div class="portfolio-card">
                        <div class="portfolio-bg-blue">
                            <div class="portfolio-img-management">
                                <img src="{{ url('public/assets/images/member8.png') }}" alt="">
                            </div>
                            <div class="text-center">
