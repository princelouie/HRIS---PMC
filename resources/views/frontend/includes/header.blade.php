...
<head>
    ...
    <link rel="shortcut icon" href="{{ Storage::disk('s3')->url(config('settings.app')['company_icon']) }}" type="image/x-icon" >
    ...
    <link rel="stylesheet" href="{{ asset('public/frontend/css/bootstrap-icons.min.css') }}">
