<style>
    ...
    .contact-form .form-control:focus, .contact-form .form-text-area:focus {
        border-color: #7f58fe;
...
<div class="contact-form-wrapper">
    ...
    <form action="#" class="contact-form" id="quickContactForm">
        ...
        <div>
            <input type="text" class="form-control rounded border-white mb-3 form-input" id="name" placeholder="{{ _trans('frontend.Name *') }}"
                required>
        </div>
        <div>
            <input type="email" class="form-control rounded border-white mb-3 form-input" id="email" placeholder="{{ _trans('frontend.Email *') }}" required>
        </div>
        <div>
...
<button id="leaveMessageBtn" class="gradient-btn">
...
@push('script')
<script src="{{ asset('public/frontend/js/v1/__mStype.js') }}"></script>
@endpush
