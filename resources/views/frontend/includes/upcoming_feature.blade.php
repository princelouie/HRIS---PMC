                        ...
                        <div class="upcoming-feature-box d-flex flex-column flex-lg-row flex-md-row flex-xl-row">
                            ...
                            <div class="feature-box-group d-flex flex-column">
                                <div
                                    ...
                                    <img src="{{ url('public/images/payroll-time-management.svg') }}" alt="">
                                ...
                                <div
                                    ...
                                    <img src="{{ url('public/images/payroll_items-administration.svg') }}"
                                        alt="">
                                    <h2>Ticket</h2>
                                </div>
                            </div>
            ...
            <div class="container bg-gradient-frontend statictics-upper-container">
                <div
                    ...
                    <div class="col-6 col-md-3 col-lg-3 col-xl-3 statictics-item mb-2">
                        <img src="{{ url('public/images/hired-1.svg') }}" alt="">
                        <h3>260+</h3>
                        <p>people hired</p>
                    </div>
                    <div class="col-6 col-md-3 col-lg-3 col-xl-3 statictics-item mb-2">
                        <img src="{{ url('public/images/feedback-1.svg') }}" alt="">
                        <h3>320+</h3>
                        <p>satisfied hired</p>
                    </div>
                    <div class="col-6 col-md-3 col-lg-3 col-xl-3  statictics-item mt-2">
                        <img src="{{ url('public/images/client-1.svg') }}" alt="">
                        <h3>170+</h3>
                        <p>company using</p>
                    </div>
                    <div class="col-6 col-md-3 col-lg-3 col-xl-3  statictics-item mt-2">
                        <img src="{{ url('public/images/support-1.svg') }}" alt="">
                        <h3>90+</h3>
