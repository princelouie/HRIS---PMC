    ...
    <div class="container new-main-content">
        ...
        <form action="{{route('analytics') }}" method="get" onchange="submit()">
          <select class="form-select text-center form-control-lg mb-3" aria-label="" name="frequency">
            ...
            <option value="daily" {{$data['frequency'] == "daily" ? 'selected':''}}>{{ _trans('common.Daily') }}</option>
            <option value="weekly" {{$data['frequency'] == "weekly" ? 'selected':''}}>{{ _trans('common.Weekly') }}</option>
            <option value="monthly" {{$data['frequency'] == "monthly" ? 'selected':''}}>{{ _trans('common.Monthly') }}</option>
            <option value="yearly" {{$data['frequency'] == "yearly" ? 'selected':''}}>{{ _trans('common.Yearly') }}</option>
          </select>
        </form>
