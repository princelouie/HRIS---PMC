            ...
            <div class="card-body login-card-body">
                ...
                <form action="#" method="post" id="login" class="password_reset_form">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="code" class="form-control" placeholder="{{ _trans('auth.Verification Code') }}">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="password" placeholder="{{ _trans('auth.password') }}" class="form-control">
                    </div>
