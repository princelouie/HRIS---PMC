...
@section('style')
    <style>
        .with-parallelogram .with-parallelogram-1.reg-breadcrumb {
            background-image: url(/public/frontend/img/body/reg.png);
        }
        ...
        .contact-form-box:before {
            background-image: url(/public/images/pattern-map-1.1.png);
        }
