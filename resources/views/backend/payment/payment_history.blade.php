                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6 invoice_description">
                                                                        <p>
                                                                            <strong>{{ _trans('payment_method.Issue Name') }} :</strong> {{ @$data['payment']->user->name }}
                                                                        </p>
                                                                    </div>
                                                                    <div
                                                                        class="col-sm-6 invoice_description invoice_right_description pull-right text-right">
                                                                        <p>
                                                                            <strong>{{ _trans('payment_method.Issue Date :') }} </strong> {{ date_format_for_view($data['payment']->created_at) }} <br>
                                                                        </p>
                                                                        <p>
                                                                            <strong>{{ _trans('payment_method.Invoice No :') }} </strong> {{ $data['payment']->invoice_number }} <br>
                                                                        </p>
                                                                    </div>
                                                                ...
                                                                <table
                                                                    ...
                                                                    <thead>
                                                                        <tr class="borer_bottom">
                                                                            <th class="text-center" width="85%">{{ _trans('payment_method.Month') }}</th>

                                                                            <th>{{ _trans('common.Action') }}</th>>{{ _trans('payment_method.Amount') }}</th>
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-right">{{ _trans('payment_method.Sub Total :') }}</td>
                                                                        <td class="text-right">{{ $data['payment']->paid_amount }}৳</td>

                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-right">{{ _trans('payment_method.Total Due:') }}</td>
                                                                        <td class="text-right">{{ $data['payment']->due_amount }}৳</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-right">{{ _trans('payment_method.Total Paid Amount:') }}</td>
                                                                        <td class="text-right">{{ $data['payment']->paid_amount }}৳</td>
                                                                    </tr>
                                                                    </tbody>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <p class="text-uppercase"> <strong>{{ _trans('payment_method.In Words:') }}</strong>{{ numberTowords($data['payment']->paid_amount) }} {{ _trans('payment_method.Only .') }}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
