    ...
    <div>
        ...
        <div style="background: #eceff4;padding: 1rem;">
            <table>
                <tr>
                    <td>
                        <img class="full-logo white_logo" src="{{ uploaded_asset(@base_settings('company_logo_backend')) }}" alt="" />
                    </td>
        ...
        <div style="padding: 1rem;padding-bottom: 0">
            <table>
                ...
                <tr>
                    <td class="gry-color small">{{ _trans('common.Email') }}: {{ $data['project']->client->email }}</td>
                </tr>
                <tr>
                    <td class="gry-color small">{{ _trans('common.Phone') }}: {{ $data['project']->client->phone }}</td>
                </tr>
            </table>
        </div>
