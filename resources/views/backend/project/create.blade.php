                    ...
                    <div class="col-lg-12">
                        ...
                        <form action="{{ $data['url'] }}" enctype="multipart/form-data" method="post" id="attendanceForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label for="#" class="form-label">{{ _trans('client.Client') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-6 total_rate">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="total_rate"
                                            class="form-control ot-form-control ot-input" value="{{ old('total_rate') }}" placeholder="{{ _trans('project.Enter Total Rate') }}"
                                            required id="total_rate" onkeyup="calculateAmount(this.value)">
                                ...
                                <div class="col-lg-6 per_rate d-none">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="per_rate" class="form-control ot-form-control ot-input" placeholder="{{ _trans('project.Enter Per Rate') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="estimated_hour"
                                            class="form-control ot-form-control ot-input" placeholder="{{ _trans('project.Estimated Hours') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="amount"
                                            ...
                                            value="{{ old('amount') }}" placeholder="{{ _trans('common.Enter Amount') }} " required>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="content" placeholder="{{ _trans('common.Enter Description') }}" class="form-control content" required>{{ old('content') }}</textarea>
