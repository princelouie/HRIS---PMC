                    ...
                    <div class="col-md-12">
                        <form action="{{ $data['url'] }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control ot-form-control ot-input" min="1" name="amount" id="Amount" autocomplete="off" value="{{ $data['project']->due  }}" />
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea type="text" name="description" rows="5" class="form-control ot-input mt-0" placeholder="{{ _trans('common.Enter payment note') }}"
                                    required>{{  old('description') }}</textarea>
                            </div>
                            <div class="form-group text-right d-flex justify-content-end">
                                <button type="submit" class="btn btn-gradian pull-right"><b>{{ _trans('common.Submit') }}</b></button>
                            </div>
                        </form>
