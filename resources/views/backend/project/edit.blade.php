                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control ot-form-control ot-input" placeholder="{{ _trans('common.Enter Name') }}"
                                ...
                                <div
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="total_rate"
                                            class="form-control ot-form-control ot-input" placeholder="{{ _trans('project.Enter Total Rate') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="estimated_hour"
                                            ...
                                            value="{{ @$data['edit']->estimated_hour }}" id="estimated_hour" required placeholder="{{ _trans('project.Enter Estimated Hours') }}"
                                            onkeyup="calculateAmount(this.value)">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label">{{ _trans('common.Amount') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="number" name="amount" placeholder="{{ _trans('common.Enter Amount') }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group ">
                                        <label class="form-label">{{ _trans('common.Description') }} <span
                                                class="text-danger">*</span></label>
                                        <textarea type="text" name="content" class="form-control content" placeholder="{{ _trans('common.Enter Description') }}" required><?= @$data['edit']->description ?> </textarea>
