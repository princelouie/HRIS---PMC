                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="name">{{ _trans('settings.Distance') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="number" id="distance" class="form-control ot-form-control ot-input"
                                        value="{{ old('distance') }}" required placeholder="{{ _trans('settings.Enter Distance') }}">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="name">{{ _trans('settings.Location') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-6 d-none">
                                        <input id="pac-input"
                                            class="form-control ot-form-control ot-input controls location" type="text"
                                            placeholder="{{ _trans('settings.Enter Location') }}" required name="location"
