                ...
                <div class="row ">
                    ...
                    <div class="col-md-6 mb-24">
                        <div class="form-group">
                            ...
                            <input type="number" id="distance" class="form-control ot-form-control ot-input"
                                value="{{ @$data['location']->distance }}" required placeholder="{{ _trans('settings.Enter Distance') }}">
                    ...
                    <div class="col-md-6 mb-24">
                        <div class="form-group" id="_st">
                            ...
                            <select id="status_id" class="form-select ot-input select2" required>
                    ...
                    <div class="col-lg-12 mb-24">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 d-none">
                                <input id="pac-input" class="form-control controls location ot-form-control ot-input"
                                    type="text" placeholder="{{ _trans('settings.Enter Location') }}" value="{{ @$data['location']->address }}"
