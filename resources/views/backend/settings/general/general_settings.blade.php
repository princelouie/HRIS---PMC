                                    ...
                                    <fieldset class="form-group mb-5">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group row mb-3"><label class="col-sm-3 col-form-label">
                                                            {{ _trans('common.Note') }} <span
                                                                class="text-danger"></span></label>
                                                        <div class="col-sm-9">
                                                            <div>
                                                                <input type="text" name="default_note" id="default_note"
                                                                    required="required"
                                                                    placeholder="{{ _trans('settings.Type your Note') }}"
                                                                    autocomplete="off"
                                                                    class="form-control ot-form-control ot-input mb-3"
                                                                    value="{{ @base_settings('default_note') }}">
    
                                                                @if ($errors->has('default_note'))
                                                                    <div class="invalid-feedback d-block">
                                                                        {{ $errors->first('default_note') }}</div>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
