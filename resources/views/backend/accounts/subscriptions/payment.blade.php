                        ...
                        <form role="form" action="{{ route('payments.store') }}" method="post"
                            ...
                            <div class='form-row row'>
                                <div class='form-group required'>
                                    ...
                                    <input class='form-control' type='text' name="name_on_card" placeholder="{{ _trans('payment.Enter Name on Card') }}">
                                </div>
                            </div>
                            ...
                            <div class='form-row row'>
                                <div class='form-group  required'>
                                    ...
                                    <input autocomplete='off' class='form-control card-number' type='text' placeholder="{{ _trans('payment.Enter Card Number') }}"
                                        name="card_number">
                                </div>
                            </div>
                            ...
                            <div class='form-row row'>
                                <div class='col-xs-12 col-md-4 form-group cvc required'>
                                    ...
                                    <input autocomplete='off' class='form-control card-cvc' placeholder="{{ _trans('payment.Enter CVC') }}"
                                        type='number'>
                                </div>
                                <div class='col-xs-12 col-md-4 form-group expiration required'>
                                    <label class='control-label'>{{ _trans('payment.Expiration Month') }}</label> <input
                                        class='form-control card-expiry-month' placeholder="{{ _trans('payment.Enter MM') }}" type='text'>
                                </div>
                                <div class='col-xs-12 col-md-4 form-group expiration required'>
                                    <label class='control-label'>{{ _trans('payment.Expiration Year') }}</label> <input
                                        class='form-control card-expiry-year' placeholder="{{ _trans('payment.Enter YYYY') }}" type='text'>
                                </div>
                            </div>
