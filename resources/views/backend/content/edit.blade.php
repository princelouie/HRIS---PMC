                    ...
                    <div class="col-md-12">
                        ...
                        <form method="POST" action="{{ route('content.update', $data['show']->id) }}" class=""
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="meta_title"
                                            class="form-control ot-form-control ot-input" placeholder="{{ _trans('content.Meta Title') }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        <label class="form-label" for="name">{{ _trans('project.Meta Description') }}</label>
                                        <textarea class="form-control mt-0 en" placeholder="{{ _trans('content.Meta Description') }}" name="meta_description" rows="10">{{ $data['show']->meta_description }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="keywords" class="form-control ot-form-control ot-input"
                                            placeholder="{{ _trans('content.Keywords') }}" value="{{ $data['show']->keywords }}" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row mb-3">
                                        <label class="form-label" for="image" class="col-sm-2 col-form-label">{{ _trans('content.Meta Image') }}</label>
                                        <div class="col-sm-12">
                                            <div>
                                                <div class="ot_fileUploader left-side mb-3">
                                                    <input class="form-control" type="text" placeholder="{{ _trans('content.Meta Image') }}" name="" readonly="" id="placeholder">
                                ...
                                <div class="col md-12">
                                    <div class="float-right d-flex justify-content-end">
                                        <button type="submit" class="btn btn-gradian action-btn">{{ _trans('common.Update') }}</button>
                                    </div>
                                </div>
                            </div>
                    </div>
