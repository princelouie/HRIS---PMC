                        ...
                        @if (hasPermission('role_read'))
                           <form method="GET" action="#" >
                                <div class="row align-items-center  ">
                                    ...
                                    <div class="col-xl-3">
                                        <div class="form-group">
                                            <input type="date" id="start" name="date" class="form-control ot-form-control ot-input mt-3 mb-3"
                                                value="{{ date('Y-m-d') }}">
                                        </div>
                                    </div>
                                    <div class="col-xl-2">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-gradian attendance_table_form height48">{{ _trans('common.Submit') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
