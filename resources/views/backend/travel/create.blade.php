                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label for="#" class="form-label">{{ _trans('travel.Motive') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="motive" class="form-control ot-form-control ot-input" placeholder="{{ _trans('travel.Enter Motive') }}"
                                            required value="{{ old('motive') }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label for="#" class="form-label">{{ _trans('travel.Place') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="place" class="form-control ot-form-control ot-input" placeholder="{{ _trans('travel.Enter Place') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label">{{ _trans('travel.Expected Amount') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="number" name="expect_amount" placeholder="{{ _trans('travel.Enter Expected Amount') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label">{{ _trans('travel.Actual Amount') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="number" name="actual_amount" placeholder="{{ _trans('travel.Enter Actual Amount') }}"
                                            class="form-control ot-form-control ot-input" id="amount"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        <label class="form-label">{{ _trans('common.Description') }} <span
                                                class="text-danger">*</span></label>
                                        <textarea type="text" name="content" placeholder="{{ _trans('common.Enter Description') }}" class="form-control content">{{ old('content') }}</textarea>
