                    ...
                    <div class="col-md-12">
                        <form action="{{ $data['url'] }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="expect_amount" class="form-control ot-form-control ot-input" placeholder="{{ _trans('common.Expect Amount') }}"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="amount" class="form-control ot-form-control ot-input"
                                    value="{{ @$data['travel']->amount  }}" required placeholder="{{ _trans('common.Approve Amount') }}">
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group text-right d-flex justify-content-end">
                                <button type="submit" class="btn btn-gradian pull-right"><b>{{ @$data['button'] }}</b></button>
                            </div>
                        </form>
