                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="gift" class="form-control ot-form-control ot-input" placeholder="{{ _trans('award.Enter gift') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label">{{ _trans('common.Amount') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="number" name="amount" class="form-control ot-form-control ot-input" placeholder="{{ _trans('common.Enter Amount') }}"
                                            id="amount"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label">{{ _trans('common.Award Information') }} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="award_info" placeholder="{{ _trans('common.Enter Award Information') }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        <label class="form-label">{{ _trans('common.Description') }} <span
                                                class="text-danger">*</span></label>
                                        <textarea type="text" name="content" class="form-control content" required placeholder="{{ _trans('common.Enter Description') }}">{!! @$data['edit']->description !!}</textarea>
