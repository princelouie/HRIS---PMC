                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="gift" class="form-control ot-form-control ot-input" required
                                            value="{{ old('gift') }}" placeholder="{{ _trans('award.Enter gift') }}">
                                        @if ($errors->has('gift'))
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="amount" class="form-control ot-form-control ot-input" id="amount"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="award_info" class="form-control ot-form-control ot-input" id="award_info" placeholder="{{ _trans('common.Enter Award Information') }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea type="text" name="content" class="form-control content" required placeholder="{{ _trans('common.Enter Description') }}">{{ old('content') }}</textarea>
