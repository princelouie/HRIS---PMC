                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="location" class="form-control" placeholder="{{ _trans('settings.Location') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">{{ _trans('settings.IP Address') }} <span class="text-danger">*</span></label>
                                            <input type="text" name="ip_address" class="form-control"
                                                placeholder="{{ _trans('settings.IP Address') }}" value="{{ old('ip_address') }}" required>
