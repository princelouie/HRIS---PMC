                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 ">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="target" id="target"
                                            class="form-control ot-form-control ot-input" required placeholder="{{ _trans('performance.Enter Target Achievement') }}" value="{{ @$data['edit']->target }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 ">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" name="start_date" id="start_date"
                                            class="form-control ot-form-control ot-input" required value="{{ @$data['edit']->start_date }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 ">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="status" id="status" class="form-select select2-input ot-input mb-3 modal_select2" required>
                                ...
                                <div class="col-lg-12 ">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control ot-input" name="description" id="description" placeholder="{{ _trans('common.Enter Description') }}" rows="5" required>{{ @$data['edit']->description }}</textarea>
                                    </div>
                                </div>
