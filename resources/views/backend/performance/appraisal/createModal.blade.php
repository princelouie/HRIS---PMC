                            ...
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title"
                                            class="form-control ot-form-control ot-input" placeholder="{{ _trans('common.Title') }}" required
                                            value="{{ old('title') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-0 ot-input" placeholder="{{ _trans('common.Enter Remarks') }}" name="remarks" id="remarks" rows="5" required></textarea>
                                    </div>
                                </div>
