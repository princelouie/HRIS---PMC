                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="shift_id" class="form-select select2-input ot-input mb-3 modal_select2"
                                            required>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="title" id="title" placeholder="{{ _trans('performance.Enter Title') }}"
                                            class="form-control ot-form-control ot-input" required value="{{  @$data['edit'] ? @$data['edit']->name : old('title') }}">
                                        @if ($errors->has('title'))
