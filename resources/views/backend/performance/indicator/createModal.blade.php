                            ...
                            <div class="row mb-20">
                                <div class="col-md-6 form-group">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="department_id" id="department_id" class="form-select select2-input ot-input mb-3 modal_select2" required>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="designation_id" id="designation_id"  class="form-select select2-input ot-input mb-3 modal_select2" required>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="shift_id" id="shift_id" class="form-select select2-input ot-input mb-3 modal_select2" required>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control ot-form-control ot-input" required placeholder="{{ _trans('performance.Enter Title') }}"
                                            value="{{ old('title') }}">
                                        @if ($errors->has('title'))
