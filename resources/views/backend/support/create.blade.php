            ...
            <div class="card-body">
                <form action="{{ route('supportTicket.store') }}" enctype="multipart/form-data" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                <label for="#" class="form-label">{{ _trans('common.Priority') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                <label for="subject" class="form-label">{{ _trans('common.Subject') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" name="description" placeholder="{{ _trans('common.Enter Description') }}" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <div class="ot_fileUploader left-side mb-3">
                                    <input class="form-control" type="text" placeholder="{{ _trans('common.Description') }}" name="" readonly="" id="placeholder">
