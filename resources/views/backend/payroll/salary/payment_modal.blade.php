                    ...
                    <div class="col-md-12">
                        <form action="{{ $data['url'] }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control ot-input ot-form-control" min="0" step=any name="amount" id="Amount" autocomplete="off" value="{{ $data['advance']->due_amount  }}" />
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea type="text" name="description" rows="5" class="form-control ot-input" placeholder="{{ _trans('common.Enter payment note') }}"
