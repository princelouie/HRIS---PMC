                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label class="form-label">
                                        {{ _trans('payroll.Basic Salary') }} <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="number" class="form-control ot-form-control ot-input" name="basic_salary" placeholder="{{ _trans('payroll.Enter Basic Salary') }}"
