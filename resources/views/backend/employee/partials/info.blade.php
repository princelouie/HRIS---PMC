<div class="profile-body p-40 pl-40 pr-40 pt-10">
    ...
    <div class="profile-body-form">
        ...
        <div class="form-group mt-20">
            ...
            <input type="text" class="form-control ot-form-control ot-input" placeholder="{{ _trans('profile.Enter Passport Number') }}" name="passport_number"
        ...
        <div class="form-group mt-20">
            ...
            <input type="text" class="form-control ot-form-control ot-input" placeholder="{{ _trans('profile.Enter NID Number') }}" name="nid_card_number"
        ...
        <div class="form-group mt-20">
            ...
            <input type="text" class="form-control ot-form-control ot-input" placeholder="{{ _trans('profile.Enter TIN') }}" name="tin"
