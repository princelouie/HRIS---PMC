                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <div class="form-group">
                                        <label for="image">{{ _trans('employee.Profile Picture') }}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">{{ _trans('employee.Name') }}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="phone">{{ _trans('employee.Phone') }}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="email">{{ _trans('employee.Email') }}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="permanent_address">{{ _trans('employee.Permanent Address') }}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="current_address">{{ _trans('employee.Current Address') }}</label>
